        ...
        <Grid container spacing={2}>
                ...
                </MenuItem>
                {
                  colors.map((color, index) => <MenuItem value={color.name}>
                    <div className="flex gap-3">
                      <span style={{ backgroundColor: color.hex }} className={`
          ...
          <Grid size={{ xs: 12, md: 4, lg: 4 }}>
            ...
            >
              ...
              >
                {
                  formik.values.category && categoryTwo[
          ...
          <Grid size={{ xs: 12 }}>
            ...
            >
              {
                false ? <CircularProgress size="small" sx={{ width: "27px", height: "27px" }} /> : "AddProduct"
              }
            </Button>
          </Grid>
        </Grid>
