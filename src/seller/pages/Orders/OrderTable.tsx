...
const OrderTable = () => {  
  ...
  const handleUpdateOrderStatus = (orderId:number , orderStatus:any) => () => {
    dispatch(updateOrderStatus({jwt:localStorage.getItem("jwt") || "" , orderId : orderId , orderStatus:orderStatus}))
  }
  return (
            ...
            <StyledTableRow key={item.id}>
              ...
              <StyledTableCell>
                <div className="flex gap-1 flex-wrap">
                  {
                    item.orderItem.map((orderItem) => <div className="flex gap-5">
                      <img
              ...
              <StyledTableCell align="right">
                <span className="px-5 py-2 border rounded-full text-primary border-primary">
                  {item.orderStatus}
                </span>
              </StyledTableCell>
              <StyledTableCell align="right">
